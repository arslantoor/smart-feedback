...
#     question_key = models.ForeignKey(Question, on_delete=models.CASCADE, default=False, null=True, blank=True)
...
#     product_id = models.CharField(max_length=50, default=False, null=True, blank=True)
#     review_hash = models.CharField(max_length=50, default=False, null=True, blank=True)
#     review_status = models.CharField(max_length=50, default=False, null=True, blank=True)
#     is_published = models.BooleanField(null=True, blank=True)
#     published_at = models.BooleanField(null=True, blank=True)
#     is_withdrawn = models.IntegerField(default=False, null=True, blank=True)
#     withdrawn_at = models.IntegerField(default=False, null=True, blank=True)
#     result_forms_id = models.IntegerField(default=False, null=True, blank=True)
#     results_form_default_language = models.IntegerField(default=False, null=True, blank=True)
#     results_ip_address = models.IntegerField(default=False, null=True, blank=True)
...
#     results_questions_question_tags = models.IntegerField(default=False, null=True, blank=True)
#     results_questions_cloned_from = models.IntegerField(default=False, null=True, blank=True)
#     results_questions_answer_value = models.IntegerField(default=False, null=True, blank=True)
#     results_questions_answer_value_option_option_id = models.IntegerField(default=False, null=True, blank=True)
#     results_questions_answer_value_option_option_label = models.IntegerField(default=False, null=True, blank=True)
#     results_questions_answer_value_option_linked_questions = models.IntegerField(default=False, null=True, blank=True)
...
class ActivityStream(models.Model):
    ...
    last_opened_from_browser = models.CharField(max_length=20, default=False, null=True, blank=True)
    last_opened_from_location = models.CharField(max_length=20, default=False, null=True, blank=True)
    last_opened_from_location_city = models.CharField(max_length=20, default=False, null=True, blank=True)
